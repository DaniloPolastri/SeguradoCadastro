...
public class Segurado {
	...
	private String rg;
	private String sexo;
	private String[] seguros; // Tipos de seguro (AUTO, RESIDENCIAL, VIDA)
	private String correntista; // Se é ou não correntista ex: Sim não
	private String[] diasVisita; // Dias da semana (Segunda até sexta)
